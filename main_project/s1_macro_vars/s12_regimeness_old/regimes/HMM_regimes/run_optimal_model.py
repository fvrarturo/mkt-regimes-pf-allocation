#!/usr/bin/env python3
"""
Run HMM analysis with optimal 2-variable combination (Growth + Policy).

This script runs the same analysis as main.py but uses only Growth and Policy variables,
which was found to be the optimal combination (lowest BIC).
"""
...
class OptimalHMMAnalyzer:
    """
    HMM analyzer using optimal 2-variable combination (Growth + Policy).
    """
    ...
    def __init__(
        ...
        self.variables = ['growth_factor', 'monetary_policy_factor']  # Optimal combination
    ...
    def combine_data(self) -> pd.DataFrame:
        ...
        # Drop rows with missing variables (only the ones we need)
    ...
    def select_best_k(self, k_values: List[int] = [2, 3, 4]) -> int:
        ...
        # Prepare features with only selected variables
    ...
    def fit_hmm(self) -> HMMRegimeModel:
        ...
        print("\n" + "=" * 80)
        print("FITTING HMM MODEL (Growth + Policy)")
        print("=" * 80)
    ...
    def run_full_analysis(self):
        ...
        print("=" * 80)
        print("HMM REGIME DETECTION - OPTIMAL 2-VARIABLE MODEL")
        print("Variables: Growth + Policy")
        print("=" * 80)
